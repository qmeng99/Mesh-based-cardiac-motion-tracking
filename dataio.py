...
class TrainDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        input_sa, input_2ch, input_4ch, contour_sa, contour_2ch, contour_4ch, contour_sa_ed, contour_2ch_ed, contour_4ch_ed, \
...
def load_data(data_path, filename, T_num, rand_frame=None):
    ...
    vertices_path = join(data_path, filename, 'contourpara', 'vertices_ED.npy')
    faces_path = join(data_path, filename, 'contourpara', 'faces_ED.npy')
