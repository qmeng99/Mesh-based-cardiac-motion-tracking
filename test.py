...
def test_all(sub_path):
    ...
    for name in glob.glob(os.path.join(sub_path, '*')):
        ...
        with torch.no_grad():
            ...
            _, hd_sa = compute_sa_mcd_hd(v_sa_hat_es_cp, contour_sa_es, sa_sliceall)
            ...
            _, hd_2ch = distance_metric(idx_2ch, idx_2ch_gt, 1.25)
            ...
            _, hd_4ch = distance_metric(idx_4ch, idx_4ch_gt, 1.25)
